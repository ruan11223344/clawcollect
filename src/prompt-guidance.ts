...
Available commands:
- /collect connect — show hosted setup steps or parse a pasted signup config block
- /collect connect hosted <workspace name> | <owner email> — create hosted access entirely from chat
